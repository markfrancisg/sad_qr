...
try {
    ...
    $total_records = count_account_list_unverified($pdo);

    $total_no_of_pages = ceil($total_records / $total_records_per_page);

    $results = get_user_list_unverified($pdo, $offset, $total_records_per_page);
    ...
    if (isset($_GET['searchButton'])) {
        ...
        $results = search_unverified_accounts($pdo, $searchInput);
    }

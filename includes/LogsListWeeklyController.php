...
//     $total_records = count_logs_list_weekly($pdo);

//     $total_no_of_pages = ceil($total_records / $total_records_per_page);

//     $results = get_logs_list_weekly($pdo, $offset, $total_records_per_page);
...
//         $results = search_weekly($pdo, $searchInput);
//     }
...
try {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'GET') {
        ...
        // Fetch logs list
        $logs = get_logs_list_weekly($pdo, $offset, $totalRecordsPerPage);

        // Fetch total number of records for pagination
        $totalRecords = count_logs_list_weekly($pdo);

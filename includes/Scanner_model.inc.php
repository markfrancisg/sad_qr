...
{
    $query = "SELECT qr_info.qr_id, qr_info.wheel, qr_info.vehicle_type, qr_info.plate_number, qr_info.qr_code, qr_info.vehicle_color, homeowners.first_name,homeowners.middle_name, 

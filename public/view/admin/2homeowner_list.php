                    ...
                    <div class="row mb-2 justify-content-end align-items-center">
                        <div class="col-md-4 order-md-2 order-1 mb-2">
                            <div class="input-group">
                                <input class="form-control me-2" type="text" id="searchInput" placeholder="Enter Name" aria-label="Search">
                                ...
                                ?>
                                    <tr id="row_<?php echo $ho_id; ?>">
                                        <td class="border-bottom-0 text-center">
                                            <input type="checkbox" class="input_checkbox" value="<?php echo $ho_id; ?>" />
                                        </td>
                                        <td class="border-bottom-0 text-center">
                                            <h6 class="text-dark mb-0"><?php echo $first_name . " " . $last_name; ?></h6>
                                        </td>
                                        <td class="border-bottom-0 text-center">
                                            <h6 class="text-dark mb-0"><?php echo htmlspecialchars(trim($email)); ?></h6>
                                        </td>
                                        <td class="border-bottom-0 text-center">

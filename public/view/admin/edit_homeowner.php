                ...
                <div class="container">
                    <form method="post" action="../../../includes/admin/edit_homeowners.inc.php" id="addHomeownerForm" class="needs-validation" novalidate>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-4">
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" id="middle_name" name="middle_name" placeholder="Pena" value="<?php echo $middle_name ?>" maxlength="30">
                        ...
                        <div class="row mt-3">
                            <div class="col-12 col-md-6 offset-md-3 d-flex justify-content-center">
                                <button class="btn btn-primary p-3 w-50 mb-2" type="submit" disabled>Edit Homeowner</button>
                            </div>
                            <div class="col-12">
                                <?php

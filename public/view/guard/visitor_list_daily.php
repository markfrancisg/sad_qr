    ...
    <div class="container-fluid">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Daily Visitor List</li>
            </ol>
        </nav>

        <div class="card" id="qr_pagination">
            <div class="card-body">
                <h2 class="fw-semibold mb-4 text-center">Daily Visitor List</h2>
                    ...
                    <div class="container">
                        <div class="row mb-2 justify-content-end align-items-center">
                            <div class="col-md-4 order-md-2 order-1 mb-2">
                                <a href="visitor_list_daily.php" class="btn btn-warning w-100">

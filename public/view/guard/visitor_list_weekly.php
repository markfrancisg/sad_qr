...
require_once '../../../includes/VisitorListWeeklyController.php'; // 
...
<div class="container-fluid">
    <div class="container-fluid">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"> <a href="visitor_list.php">Visitor List</a></li>
                <li class="breadcrumb-item active" aria-current="page">Weekly Visitor List</li>
            </ol>
        </nav>

        <div class="card" id="qr_pagination">
            <div class="card-body">
                <h2 class="fw-semibold mb-4 text-center">Weekly Visitor List</h2>
                                    ...
                                    <div class="container-fluid">
                                        <ul class="nav nav-pills d-flex flex-row flex-nowrap">
                                            <li class="nav-item me-2">
                                                <a class="nav-link " aria-current="page" href="visitor_list.php">All</a>
                                            </li>
                                            <li class="nav-item me-2">
                                                <a class="nav-link" href="visitor_list_daily.php">Daily</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link active" href="visitor_list_weekly.php">Weekly</a>
                                            </li>
                                        </ul>
                                    </div>
                                </nav>
                    ...
                    <div class="container">
                        <div class="row mb-2 justify-content-end align-items-center">
                            <div class="col-md-4 order-md-2 order-1 mb-2">
                                <a href="visitor_list_weekly.php" class="btn btn-warning w-100">

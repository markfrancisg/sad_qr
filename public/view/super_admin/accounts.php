                    ...
                    <form class="user" method="post" action="../../../includes/super_admin/create_account.inc.php" id="createAccountForm">
                        <div class="row">
                            ...
                            <div class="col-sm-4 mb-3">
                                <input type="text" class="form-control form-control-user form-control-color" id="first_name" name="first_name" placeholder="First Name" maxlength="30">
                                <div class="error-container  mt-1 p-2"> <span class="error"></span></div>
                            </div>

                            <div class="col-sm-4 mb-3">
                                <input type="text" class="form-control form-control-user form-control-color" id="last_name" name="last_name" placeholder="Last Name" maxlength="30">
                                <div class="error-container  mt-1 p-2"> <span class="error"></span></div>
                            </div>

                            <div class="col-sm-4 mb-3">
                                <select class="form-control form-control-drop-down form-control-color" id="role_description" name="role_description">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 mb-3">
                                <input type="email" class="form-control form-control-user form-control-color" id="email" name="account_email" placeholder="Email Address" maxlength="50">
                                <div class="error-container mt-1 p-2"> <span class="error"></span></div>
                            </div>

                            <div class="col-sm-6 mb-3">
                                <input type="text" class="form-control form-control-user form-control-color" id="number" name="account_number" placeholder="Phone Number" maxlength="11">
                                <div class="error-container  mt-1 p-2"> <span class="error"></span></div>
                            </div>
